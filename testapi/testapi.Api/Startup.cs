...
using Byui.testapi.Api.Helpers;
...
using Constants = Byui.testapi.Api.Helpers.Constants;


namespace Byui.testapi.Api
{
    /// <summary>
    /// 
    /// </summary>
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info
                {
                    Version = "v1",
                    Title = "testapi API",
                    Description = "API for testapi application",
                    TermsOfService = "None",
            ...
            // configure automapper and dependancy injection ** For testapi.Business
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
           ...
           if (env.IsDevelopment())
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(endpoint, "testapi API V1");
