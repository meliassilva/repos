...
using Byui.Something.Api.Helpers;
...
using Constants = Byui.Something.Api.Helpers.Constants;


namespace Byui.Something.Api
{
    /// <summary>
    /// 
    /// </summary>
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
           ...
           if (env.IsDevelopment())
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(endpoint, "Something API V1");
