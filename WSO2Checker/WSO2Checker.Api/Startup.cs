...
using Byui.WSO2Checker.Api.Helpers;
...
using Constants = Byui.WSO2Checker.Api.Helpers.Constants;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "WSO2Checker API",
                    Description = "API for WSO2Checker application",
                    TermsOfService = "None",
            ...
            // configure automapper and dependancy injection ** For WSO2Checker.Business
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
           ...
           if (env.IsDevelopment())
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(endpoint, "WSO2Checker API V1");
