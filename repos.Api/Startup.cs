...
using Constants = Byui.repos.Api.Helpers.Constants;


namespace Byui.repos.Api
{
    /// <summary>
    /// 
    /// </summary>
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info
                {
                    Version = "v1",
                    Title = "repos API",
                    Description = "API for repos application",
                    TermsOfService = "None",
            ...
            // configure automapper and dependancy injection ** For repos.Business
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
           ...
           if (env.IsDevelopment())
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(endpoint, "repos API V1");
