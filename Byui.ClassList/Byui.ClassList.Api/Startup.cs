...
using Byui.Byui.ClassList.Api.Helpers;
...
using Constants = Byui.Byui.ClassList.Api.Helpers.Constants;


namespace Byui.Byui.ClassList.Api
{
    /// <summary>
    /// 
    /// </summary>
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Byui.ClassList API",
                    Description = "API for Byui.ClassList application",
                    TermsOfService = "None",
            ...
            // configure automapper and dependancy injection ** For Byui.ClassList.Business
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
           ...
           if (env.IsDevelopment())
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(endpoint, "Byui.ClassList API V1");
