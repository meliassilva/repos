...
using Byui.StudentListApi.Api.Helpers;
...
using Constants = Byui.StudentListApi.Api.Helpers.Constants;
using Byui.LmsClients.LmsDataClient;

namespace Byui.StudentListApi.Api
{
    /// <summary>
    /// 
    /// </summary>
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "StudentListApi API",
                    Description = "API for StudentListApi application",
                    TermsOfService = "None",
            ...
            services.AddScoped(provider => new LmsDataClient(56665));

            // configure dependency injection
            services.AddScoped<ApiExceptionFilter>();

            // configure automapper and dependancy injection ** For StudentListApi.Business
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
           ...
           if (env.IsDevelopment())
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(endpoint, "StudentListApi API V1");
